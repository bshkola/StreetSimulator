...
struct CameraObservation {
    ...
    CameraObservation(Camera camera, float object_x, float object_y,
                      float object_distance, float object_azimuth):
                      camera(camera), object_x(object_x), object_y(object_y),
                      object_distance(object_distance),
                      object_azimuth(object_azimuth)
    {};
